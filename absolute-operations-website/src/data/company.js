export const company = {
  name: 'Absolute Operations, LLC',
  tagline: 'Cutting-edge operations without enterprise-level cost.',
  email: 'braden@absoluteoperations.com',
  phone: '(000) 000-0000',
  location: 'City, State',
  ...
  values: [
    ...
    ['Confidential', 'We respect sensitive project information and encourage NDA protection before proprietary details are shared.'],
    ['Scalable', 'We design with the next phase in mind so the first solution does not become the next bottleneck.']
  ]
};
